...
Radiology workflows require balancing specialty, availability, experience, and urgency.  
This system automates the process using a rule-based + AI-enhanced pipeline.
...
Core Tables:
resources, resource_calendar, specialty_mapping, work_requests
